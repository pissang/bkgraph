...
Graph.prototype.removeEdge = function (edge) {
    ...
    var key = n1.id + '-' + n2.id;
    if (this._directed) {
        n1.outEdges.splice(n1.outEdges.indexOf(edge), 1);
        n2.inEdges.splice(n2.inEdges.indexOf(edge), 1);   
    }
    n1.edges.splice(n1.edges.indexOf(edge), 1);
    if (n1 !== n2) {
        n2.edges.splice(n2.edges.indexOf(edge), 1);
    }
